...
const checkSubmitPassword = computed(() => {
    if (conditions.value.allConditions) {
        return true;
    }
    return false;
});
    ...
    <div class="componentcc-s1">
        <div class="containertitre">
            ...
            <div class="contenttext">
                <div class="text24px unbounded bold-text">Réinitialiser votre mot de passe</div>
            </div>
        </div>
            ...
            <form @submit.prevent="submit" class="containermdp-form">
                ...
                <div class="containercontinuer">
                    <input type="submit" :disabled="form.processing" class="button"
                        :class="checkSubmitPassword ? 'purple' : 'gray'" value="Continuer">
                </div>
            </form>
        </div>
    </div>
