...
const redirect_to = window.location.origin + "/syncItProFirstTime";
    ...
    <div class="componentcc-s1">
        <div class="containertitre">
            ...
            <div class="contenttext">
                <div class="text24px unbounded bold-text text-center">Intégrez votre tenant Microsoft et/ou Google</div>
                <div class="text14px text-center">Pour commencer, connectez-vous à votre tenant Microsoft et/ou Google
                    pour
                    synchroniser vos collaborateurs.</div>
            </div>
        </div>
        <div class="containeritpro">
            ...
            <div class="containercta-s1">
                <Link :href="route('syncSirhFirstTime')" class="lightbutton">
